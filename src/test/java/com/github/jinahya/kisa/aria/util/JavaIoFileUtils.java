...
@Slf4j
public final class JavaIoFileUtils {
     ...
     * @param append a flag for appending; {@code ture} for appending bytes to the end of the {@code file},
    ...
    public static File writeRandomBytes(final File file, final boolean append, int bytes,
                                        final byte[] buffer)
            throws IOException {
    ...
    /**
     * Creates a new empty file in specified directory, writes some(possibly zero) bytes to the file, and return the
     * file.
     *
